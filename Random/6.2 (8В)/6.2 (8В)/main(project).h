...
//
//
//    while (f1==f2 && !fin.eof()) {f2=f1; fin>>f1;}//проверка на повторы
//    while (g1==g2 && !gin.eof()) {g2=g1; gin>>g1;}//проверка на повторы
//
//
//    while (!fin.eof() && !gin.eof())
//    {
//        while (f1==f2) {f2=f1; fin>>f1;}//проверка на повторы
//        while (g1==g2) {g2=g1; gin>>g1;}//проверка на повторы
//        //при проверке на повторы в переменной 2 хранится повторяющееся число
//
//        if (f1<g1){
//            f2=f1; fin>>f1;
//            if (f2!=g1 && f2!=g2 && f2!=f1){
//                //ansOut<<f2<<"\n";
//                cout<<f2<<"\n";
//            }
//        }else{
