...
//
//        student[i].day = rand() % 29 + 1;
//
//        student[i].month = rand() % 11 + 1;
//
//        student[i].year = rand() % 11 + 1990;
//
//        student[i].course = rand() % 5 + 1;
//
...
//
//    for (int i = 0; i<N; i++){
//        fout<<student[i].name<<" "<<student[i].day<<" "<<student[i].month<<" "<<student[i].year<<" "<<student[i].course<<" "<<student[i].performance<<"\n";
//    }
//
//    fout.close();
//}
